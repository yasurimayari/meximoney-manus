...
- [ ] Diseñar un registro manual de compras financiadas y préstamos con principal, saldo, cuotas, interés, vencimientos y relación opcional con el bien adquirido.
- [ ] Vincular compras financiadas y préstamos con movimientos, pagos, deudas, Patrimonio, cierres mensuales y calendario sin duplicar gastos.
- [ ] Añadir alertas internas para corte, pago y sobregiro de tarjetas, así como vencimientos de préstamos, cuotas y obligaciones manuales.
- [ ] Evaluar canales externos opcionales de alertas —Telegram, Slack, WhatsApp u otro— por privacidad, coste, viabilidad y configuración necesaria antes de habilitarlos.
- [ ] Configurar Telegram como canal opcional con credenciales privadas, contenido mínimo y envío desactivado hasta una prueba controlada confirmada.
- [ ] Añadir una preferencia para activar o desactivar Telegram sin afectar la bandeja interna de Meximoney.
- [ ] Preparar el resumen diario de Telegram para las 08:00 de Ciudad de México con pagos, cortes, cuotas, fechas fiscales manuales y sobregiros, sin montos detallados.
