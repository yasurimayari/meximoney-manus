...
describe("efecto patrimonial de operaciones de inversión", () => {
  ...
  it("protege contra valores negativos y separa el rendimiento del costo", () => {
    ...
    expect(applyInvestmentDelta({ costBasisCents: 1_000_00, currentValueCents: 1_000_00 }, investmentOperationDelta("depreciation", 125_00))).toEqual({ costBasisCents: 1_000_00, currentValueCents: 875_00 });
  });
