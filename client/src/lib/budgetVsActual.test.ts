...
describe("Presupuesto versus Real", () => {
  it("usa sólo movimientos aprobados y conversiones manuales comparables para ingresos y gastos", () => {
    const results = calculateBudgetVsActual({
      ...
      transactions: [
        { type: "income", scope: "personal", categoryId: 10, currency: "MXN", amountCents: 12000, status: "confirmed", reviewStatus: "approved", occurredAt: "2026-08-12T12:00:00.000Z" },
        { type: "income", scope: "personal", categoryId: 10, currency: "USD", amountCents: 5000, reportCurrency: "MXN", reportAmountCents: 3000, status: "confirmed", reviewStatus: "approved", occurredAt: "2026-08-13T12:00:00.000Z" },
        { type: "income", scope: "personal", categoryId: 10, currency: "USD", amountCents: 1000, status: "confirmed", reviewStatus: "approved", occurredAt: "2026-08-14T12:00:00.000Z" },
        { type: "income", scope: "personal", categoryId: 10, currency: "MXN", amountCents: 9000, status: "needs_review", reviewStatus: "draft", occurredAt: "2026-08-15T12:00:00.000Z" },
        { type: "expense", scope: "personal", categoryId: 20, currency: "MXN", amountCents: 9000, status: "confirmed", reviewStatus: "approved", occurredAt: "2026-08-16T12:00:00.000Z" },
      ],
      investments: [],
