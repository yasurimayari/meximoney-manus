...
import { ArrowLeftRight, Award, BarChart3, BellRing, BotMessageSquare, CalendarDays, ChevronDown, ChevronRight, CircleCheckBig, CloudDownload, ContactRound, CreditCard, EyeOff, FileDown, FolderKanban, KeyRound, Landmark, LayoutDashboard, LockKeyhole, LogOut, PanelLeft, PiggyBank, ShieldCheck, Target, BookOpenCheck, Settings2, ClipboardCheck, ReceiptText, Calculator, Plane, ListChecks } from "lucide-react";
...
const primaryMenuGroups = [
  { label: "Resumen", items: [{ icon: LayoutDashboard, label: "Panel", path: "/" }, { icon: ListChecks, label: "ToDo", path: "/todo" }, { icon: BarChart3, label: "Analítica", path: "/analitica" }, { icon: BookOpenCheck, label: "Estados", path: "/estados" }, { icon: Award, label: "Score", path: "/score" }, { icon: Calculator, label: "Simulaciones", path: "/simulaciones" }] },
