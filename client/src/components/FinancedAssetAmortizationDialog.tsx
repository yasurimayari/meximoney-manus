  ...
  return <DialogContent className={dialogClass}>
    ...
    {isLoading || !data ? <p className="py-8 text-sm text-muted-foreground">Preparando tabla…</p> : <div className="min-w-0 space-y-6 pb-2">
      ...
      <section>
        ...
        <div className="overflow-x-auto rounded-xl border" aria-label="Tabla de pagos conciliados">
      ...
      <section>
        ...
        <div className="overflow-x-auto rounded-xl border" aria-label="Tabla de amortización proyectada">
